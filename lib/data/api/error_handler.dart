...
Failure _handleDioError(DioException exception) {
  if (exception.response != null) {
    return _handelFirebaseError(exception);
  } else {
...
Failure _handelFirebaseError(DioException exception) {
  switch (exception.response!.data["error"]["message"]) {
    ...
    case 'INVALID_PASSWORD':
      return Failure(
          04, 'The password is invalid or the user does not have a password.');
    case 'USER_DISABLED':
      return Failure(
